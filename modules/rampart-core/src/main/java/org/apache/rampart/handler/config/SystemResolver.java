...
public class SystemResolver implements Resolver {
    ...
    public String resolve() {
        ...
        if (envValue == null) {
            throw new IllegalArgumentException("Environment variable could not be found for " + input + ". " +
                    "Please ensure that the environment variable is set before using it in the configuration.");
        }
        return envValue;
    }
}
